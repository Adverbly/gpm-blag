...
const BlockComputationGroup = require('../../../components/BlockComputationGroup/index');
const BlockComputationSingle = require('../../../components/BlockComputationSingle/index');
          ...
          <div className="text">
            ...
            <div id="content">
              <p>Have you ever had one of those moments where you find yourself googling the definition of something for
                ...
                children. Commutativity is the property that a function like addition can have where: <pre><code>1+2=2+1</code></pre>
                Associativity is the property where, once again for addition: <pre><code>1+(2+3)=(1+2)+3</code></pre> I have probably had
